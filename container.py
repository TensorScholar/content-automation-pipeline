...
class Container(containers.DeclarativeContainer):
    ...
    # Alias for compatibility - tasks use redis_client()
    redis_client: providers.Singleton[RedisClient] = providers.Singleton(RedisClient)

    metrics: providers.Singleton[MetricsCollector] = providers.Singleton(MetricsCollector)
    
    # Alias for compatibility - tasks use metrics_collector()
    metrics_collector: providers.Singleton[MetricsCollector] = providers.Singleton(MetricsCollector)
...
class ContainerManager:
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            # Mark as initialized even if non-critical components failed
