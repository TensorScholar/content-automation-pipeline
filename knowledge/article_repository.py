...
class ArticleRepository:
    ...
    async def get_by_id(
        ...
        """
        query = select(generated_articles_table).where(
    ...
    async def delete(self, article_id: UUID) -> bool:
        ...
        """
        query = delete(generated_articles_table).where(
            generated_articles_table.c.id == article_id
        )
        result = await self.db.execute(query)
    ...
    async def get_analytics(
        ...
        stats_query = select(
            ...
            generated_articles_table.c.created_at.between(start_date, end_date)
        )
        ...
        articles_by_day_query = (
            articles_by_day_query
            .group_by(func.date(generated_articles_table.c.created_at))
    ...
    async def get_article_history(self, article_id: UUID) -> Optional[Dict[str, Any]]:
        ...
        revisions_query = select(
            ...
            article_revisions_table.c.article_id == article_id
    ...
    async def export_articles(
        ...
        articles_query = articles_query.order_by(
            generated_articles_table.c.created_at.desc()
        )
