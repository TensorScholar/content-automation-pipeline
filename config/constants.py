...
@dataclass(frozen=True)
class LLMCostModel:
    """Cost structure for all supported models (updated 2025)."""
    ...
    CLAUDE_3_5_HAIKU: ModelCosts = ModelCosts(
        input_cost=0.001, output_cost=0.005, context_window=200_000
    )

    CLAUDE_3_5_SONNET: ModelCosts = ModelCosts(
        input_cost=0.003, output_cost=0.015, context_window=200_000
    )

    # Anthropic Claude 4.5 models (current generation, 2025)
    CLAUDE_4_5_HAIKU: ModelCosts = ModelCosts(
        input_cost=0.001, output_cost=0.005, context_window=200_000
    )

    CLAUDE_4_5_SONNET: ModelCosts = ModelCosts(
        input_cost=0.003, output_cost=0.015, context_window=200_000
    )

    CLAUDE_4_5_OPUS: ModelCosts = ModelCosts(
        input_cost=0.005, output_cost=0.025, context_window=200_000
    )
