...
class ProjectService:
    ...
    def __init__(
        ...
        Args:
            ...
            rulebook_manager: Manager for rulebook operations
        """
        self.projects = project_repository
        self.rulebooks = rulebook_manager
    ...
    async def create_or_update_rulebook(
        ...
        if existing_rulebook:
            ...
            # Create new
            rulebook = await self.rulebooks.create_rulebook(
                project_id=project_id, 
                content=content
            )
    ...
    async def trigger_website_analysis(
        ...
        task = celery_app.send_task(
            "content_automation.analyze_website", 
            args=[str(project_id), project.domain]
        )
